        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="**Sᴏʀʀʏ Sɪʀ, Yᴏᴜ ᴀʀᴇ Bᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴍᴇ. Qᴜɪᴄᴋʟʏ ᴄᴏɴᴛᴀᴄᴛ** @ADVERT4U_BOT",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ** [CLICK ME](https://t.me/ADVERT4U_BOT).",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
...
"""
        ...
        await m.reply_text(
            ...
            parse_mode="HTML",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('Dᴏᴡɴʟᴏᴀᴅ📥', url=online_link)]]) #Download Link
        )
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. CLICK ME](https://t.me/ADVERT4U_BOT).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
    ...
    await message.reply_text(
       text="Send me any file/media from telegram, I'll provide external direct download link..",
          ...
          reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("😇CONNECT", url="https://t.me/ADVERT4U")]
            ]
        )
    )
